...
#[test]
fn startup_visibility_normal_launch_shows_dashboard_after_tray_setup_succeeds() {
    assert_eq!(
...
#[test]
fn startup_visibility_autostart_launch_shows_dashboard_when_tray_setup_fails() {
    assert_eq!(
